...
import { Upload, FolderPlus, ArrowUpDown, LayoutGrid } from "lucide-react";
    ...
    <>
      <div className="flex items-center gap-2 mb-5">
        ...
        <button
          disabled
          title="추후 구현"
          className="bg-white border border-border text-text-faint transition-colors px-3.5 py-2 rounded-md text-[13px] font-medium flex items-center gap-1.5 cursor-not-allowed"
        >
          <ArrowUpDown size={14} strokeWidth={2} /> 정렬
        </button>
        <button
          disabled
          title="추후 구현"
          className="bg-white border border-border text-text-faint transition-colors px-3.5 py-2 rounded-md text-[13px] font-medium flex items-center gap-1.5 ml-auto cursor-not-allowed"
        >
          <LayoutGrid size={14} strokeWidth={2} /> 보기
        </button>
